...
public class UpdateHelper {
     ...
     */
    public void update(final Context context, final boolean isForced,final String title, final String desc, final int code,
                       final String versionName, final String downloadUrl, String md5) {
