...
import com.xulu.mpush.api.PacketReader;
import com.xulu.mpush.api.PacketReceiver;
...
import com.xulu.mpush.codec.AsyncPacketReader;
import com.xulu.mpush.codec.AsyncPacketWriter;
import com.xulu.mpush.util.IOUtils;
...
import static com.xulu.mpush.api.Constants.MAX_TOTAL_RESTART_COUNT;
import static com.xulu.mpush.client.TcpConnection.State.connected;
import static com.xulu.mpush.client.TcpConnection.State.connecting;
import static com.xulu.mpush.client.TcpConnection.State.disconnected;
import static com.xulu.mpush.client.TcpConnection.State.disconnecting;
...
public final class TcpConnection implements Connection {
    ...
    private boolean doReconnect() {
        ...
        if (reconnectCount > Constants.MAX_RESTART_COUNT) {    // 超过此值 sleep 10min
