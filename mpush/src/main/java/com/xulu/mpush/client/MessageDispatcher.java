...
import com.xulu.mpush.api.MessageHandler;
...
import com.xulu.mpush.handler.AckHandler;
import com.xulu.mpush.handler.ErrorMessageHandler;
import com.xulu.mpush.handler.FastConnectOkHandler;
import com.xulu.mpush.handler.HandMarketMessageHandler;
import com.xulu.mpush.handler.HandshakeOkHandler;
import com.xulu.mpush.handler.HeartbeatHandler;
import com.xulu.mpush.handler.KickUserHandler;
import com.xulu.mpush.handler.OkMessageHandler;
import com.xulu.mpush.handler.PushMessageHandler;
...
public final class MessageDispatcher implements PacketReceiver {
    ...
    public MessageDispatcher() {
        ...
        register(Command.MARKET, new HandMarketMessageHandler());//收到行情数据
    ...
    public void onReceive(final Packet packet, final Connection connection) {
        Log.d("onReceive", "onReceive-->packet"+packet);
