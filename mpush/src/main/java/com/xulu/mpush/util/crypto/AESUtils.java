...
package com.xulu.mpush.util.crypto;
...
public final class AESUtils {
    ...
    public static byte[] decrypt(byte[] data, byte[] decryptKey, byte[] iv) {
        IvParameterSpec zeroIv = new IvParameterSpec(CipherBox.INSTANCE.aESKey());
        SecretKeySpec key = new SecretKeySpec(CipherBox.INSTANCE.aESKey(), KEY_ALGORITHM);
        try {
            Cipher cipher = Cipher.getInstance(KEY_ALGORITHM_PADDING);
