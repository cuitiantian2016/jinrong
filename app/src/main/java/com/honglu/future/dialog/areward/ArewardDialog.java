    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_areward: //打赏
                ...
                if (integralNum <= 0) {
                    ToastUtil.show("打赏牛币必须大于0");
                    return;
                }

                if (integralNum > 1000) {
                    ToastUtil.show("打赏牛币不能大于1000");
                    return;
                }
            ...
            case R.id.rl_small_layout: //6
                if (mIntegralNum == SMALL_NIUBI && mImgSmall.getVisibility() == View.VISIBLE) {
                    return;
                }
            ...
            case R.id.rl_sd_layout: //66
                if (mIntegralNum == SD_NIUBI && mImgSd.getVisibility() == View.VISIBLE) {
                    return;
                }
            ...
            case R.id.rl_big_layout: //666
                if (mIntegralNum == BIG_NIUBI && mImgBig.getVisibility() == View.VISIBLE) {
                    return;
                }
