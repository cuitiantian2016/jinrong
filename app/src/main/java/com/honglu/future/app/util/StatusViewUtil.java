...
import com.xulu.xnpacket.app.AppManager;
import com.xulu.xnpacket.base.BaseActivity;
...
public class StatusViewUtil {
     ...
     * @param height
     */
    public static void showDefaultPopWin(final BaseActivity activity, final IOnTouchRefresh touchRefresh, final int
            x, final int y, int width, int height, String style, String message) {
        ...
        if (activity.hasWindowFocus()) {
            popupWindow.showAtLocation(((ViewGroup) activity.findViewById(android.R.id.content)).getChildAt(0),
                    Gravity.TOP, x, y);
        } else {
            activity.setOnIWindowFocus(new BaseActivity.IWindowFocus() {
                ...
                public void focused() {
                    ...
                    popupWindow.showAtLocation(((ViewGroup) activity.findViewById(android.R.id.content)).getChildAt
                            (0), Gravity.TOP, x, y);
                }
