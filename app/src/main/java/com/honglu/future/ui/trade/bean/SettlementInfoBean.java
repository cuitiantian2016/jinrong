...
public class SettlementInfoBean{
    ...
    private List<CloseList> closeList;
    ...
    private List<PositionsDetailList> positionsDetailList;
    ...
    public void setDepositList(List<DepositList> depositList) {
    ...
    public void setCloseList(List<CloseList> closeList) {
        this.closeList = closeList;
    }

    public List<CloseList> getCloseList() {
        return closeList;
    }
    ...
    public void setPositionsDetailList(List<PositionsDetailList> positionsDetailList) {
        this.positionsDetailList = positionsDetailList;
    }

    public List<PositionsDetailList> getPositionsDetailList() {
