//package com.honglu.future.widget.kchart.data;
//
//
//
...
//
//            if (jsonData.get("list") == null || TextUtils.isEmpty(jsonData.get("list").toString()))
//                return list;
...
//            double totalVol = JSONObjectUtil.getDouble(jsonData, "totalVolume", 0);
//            long reqTime = JSONObjectUtil.getLong(jsonData, "reqTime", 0);
//
//            double sum = 0;
//            for (int i = 0; i < jsonArr.length(); i++) {
//                JSONObject jsonObj = jsonArr.getJSONObject(i);
...
//                entity.setVol(JSONObjectUtil.getDouble(jsonObj, "v", 0));
//
...
//            if (!data.has("candle"))
//                return list;
//            if (data.get("candle") == null || TextUtils.isEmpty(data.get("candle").toString()))
//                return list;
//
//            JSONArray jsonArr = data.getJSONArray("candle");
////            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
//            double totalVol = JSONObjectUtil.getDouble(data, "totalVolume", 0);
//
//            for (int i = 0; i < jsonArr.length(); i++) {
//                JSONObject jsonObj = jsonArr.getJSONObject(i);
//                KCandleObj entity = new KCandleObj();
...
//                entity.setVol(JSONObjectUtil.getDouble(jsonObj, "v", 0));
//                entity.setTotalVol(totalVol);
//                entity.setHold(JSONObjectUtil.getDouble(jsonObj, "i", 0));
//                if (entity.getOpen() == 0)
//                    continue;
//                if (entity.getHigh() == 0)
//                    continue;
