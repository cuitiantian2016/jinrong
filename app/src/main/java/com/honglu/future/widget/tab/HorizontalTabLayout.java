 ...
 */
public class HorizontalTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void addTab(final int position, View tabView) {
        ...
        if (position == 0){
            if (mWindMargin > 0){
                lp_tab.leftMargin = (int) mWindMargin;
            }
            if (mRightMargin > 0){
                lp_tab.rightMargin = (int) mRightMargin;
            }
        }else if (position == mTabCount -1){
            if (mWindMargin > 0){
                lp_tab.rightMargin = (int) mWindMargin;
            }
            if (mLeftMargin > 0){
                lp_tab.leftMargin = (int) mLeftMargin;
            }
        }else {
            if (mLeftMargin > 0) {
                lp_tab.leftMargin = (int) mLeftMargin;
