 ...
 * @param <Result>
 */
public abstract class CustomThreadAsyncTask<Params, Progress, Result> {
    ...
    public final CustomThreadAsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(sDefaultExecutor, params);
    }

    @SuppressWarnings("incomplete-switch")
	public final CustomThreadAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        @SuppressWarnings("rawtypes")
		final CustomThreadAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(@SuppressWarnings("rawtypes") CustomThreadAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
