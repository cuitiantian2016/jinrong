...
public class UnderLineTextView extends TextView {
    ...
    public UnderLineTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineColor = (int) attributes.getColor(R.styleable.UnderLineTextView_UnderLineColor, getCurrentTextColor());
...
//                canvas.drawLine(startX, getHeight() - mlineHeight / 2, stopX, getHeight() - mlineHeight / 2, paint);
                ...
                RectF rect = new RectF(startX, getHeight() - DeviceUtils.dip2px(context, 3), stopX, getHeight());
                canvas.drawRoundRect(rect, DeviceUtils.dip2px(context, 3), DeviceUtils.dip2px(context, 3), paint);
