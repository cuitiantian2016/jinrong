package com.honglu.future.widget.loading;
...
public class LoadingLayout extends FrameLayout {
    ...
    public static class Config {
        ...
        int emptyImgId = R.mipmap.icon_norecord;
        int errorImgId = R.mipmap.icon_error;
        int networkImgId = R.mipmap.icon_noconnect;
        int tipTextSize = 12;
