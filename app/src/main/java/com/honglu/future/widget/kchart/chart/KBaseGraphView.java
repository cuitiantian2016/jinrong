package com.honglu.future.widget.kchart.chart;
...
public class KBaseGraphView extends View {
    ...
    //十字线字体的颜色
    protected int crossFontColor = Color.WHITE;
    ...
    //经线的文字颜色 时间的颜色
    protected int longitudeFontColor = Color.parseColor("#999999");
    //纬线的文字颜色 价格颜色
    ...
    protected int rectFillColor = Color.parseColor("#595959");
    /**
     * 阳线的填充颜色
     */
    ...
    protected void initDefaultValue(Context context) {
        ...
        //axisX time
        longitudeFontSize = KDisplayUtil.dip2px(context, 10);
        //axisY price
