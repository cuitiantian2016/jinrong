...
public class NineGridImageView<T> extends ViewGroup {
    ...
    static final float DEF_RATIO = 0.45f;
    ...
    public NineGridImageView(Context context, AttributeSet attrs) {
        ...
        this.mGap = (int) typedArray.getDimension(R.styleable.NineGridImageView_ngiv_imgGap, 0);
        this.mSingleImgSize = typedArray.getDimensionPixelSize(R.styleable.NineGridImageView_ngiv_singleImgSize, -1);
        this.mShowStyle = typedArray.getInt(R.styleable.NineGridImageView_ngiv_showStyle, STYLE_GRID);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mImgDataList != null && mImgDataList.size() > 0) {
            ...
            if (mImgDataList.size() == 1) {
                height = (int) (totalWidth * DEF_RATIO + getPaddingTop() + getPaddingBottom());
            } else {
    ...
    private void layoutChildrenView() {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            if (childrenCount == 1) {
                ...
                int height = (int) (width * DEF_RATIO);
                childrenView.layout(left, top, left + width, top + height);
            } else {
            ...
            if (mAdapter != null) {
                ...
                imageView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mAdapter.onItemImageClick(v, position, mImgDataList);
                    }
                });
                return imageView;
            } else {
